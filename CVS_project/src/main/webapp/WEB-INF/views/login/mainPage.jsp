...
<body style="background : #6CC0FF; font-family: 'Jua', sans-serif;">
...
<div class="container" style="margin-top: 5%;">
	...
	<div class="row" style=" margin-top: 8%;">
		<div class="col-4">
			...
			<img src="../resources/img/payment.png" style="width: 150px; height: 150px;"><p style="margin-top: 25px; font-size: 40px;">상품판매</p></button>
		
		</div>		
		<div class="col-4">
			<button type="button" class="btn btn-primary btn-lg" id="order" style="width: 300px;height: 300px;">
			<img src="../resources/img/order.png" style="width: 150px; height: 150px;"><p style="margin-top: 25px; font-size: 40px;">상품발주</p></button>
		...
		<div class="col-4">
			...
			<img src="../resources/img/login.png" style="width: 150px; height: 150px;">
				...
				<p style="margin-top: 25px; font-size: 40px;">
